...
<html>
<head>
  <title>Error Page - System Informasi Perizinan</title>
...
<body>
  <div class="container">
        <div class="error">
          <img src="<?=base_url();?>/assets/images/insanlogo.png" style="max-height: 175px;">
            <h1>404</h1>
            <!-- <h2>error</h2> -->
            <p>Mohon maaf halaman yang anda minta tidak tersedia, silahkan kembali..</p>
            <a class="btn btn-style btn-lg" href="<?=base_url($this->session->userdata('nama_level'));?>">Kembali</a>
        </div>
