          ...
          <div class="content-wrapper">
            ...
            <div class="page-header">
              <h4 class="page-title">
                ...
                </span> Data Departemen </h4>
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">
                    <span></span>Dashboard / Master / Departemen <i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                  </li>
                </ul>
              </nav>
            </div>
              ...
              <div class="col-md-12 stretch-card grid-margin">
                <div class="card card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-gradient-dark btn-fw" onclick="add_departemen()">Add departemen</button>
                      <!-- Modal -->
                                ...
                                <div class="modal-dialog modal-md">
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h4 class="modal-title">Add data departemen</h4>
                                    </div>
                          ...
                          <?php } else{
                                  foreach ($departemen as $value) {?>
                                    <tr>
                                      ...
                                      <td>
                                         <a href="#" style="color: #5e7188; font-size: 40px;" id="btnedit" onclick="edit_departemen(<?=$value->id_departemen;?>)"><i class="mdi mdi-pencil-box-outline"></i></a>
                                      </td>
                                      <td>
                                          <a href="#" style="color: #5e7188; font-size: 40px;" id="btnupdate" onclick="delete_departemen(<?=$value->id_departemen;?>)"><i class="mdi mdi-trash-can"></i></a>
                                     </td>
                                    </tr>
                              <?php 
                                    $no++;
...
<script type="text/javascript">
    ...
    //$('.modal-title').text('Add Person'); // Set Title to Bootstrap modal title
      ...
      $("#form").submit(function(event) {
          var url;
          if(save_method == 'add'){
              url = "<?php echo site_url('master2/save_departemen')?>";
          }else{
              url = "<?php echo site_url('master2/update_departemen')?>";
          }
         swal({
              title: "Simpan data?", 
              type: "info",
                ...
                $.ajax({
                    ...
                    success: function(data) { }
                      ...
                      swal({
                          ...
                          window.location.href = "<?php echo site_url('master2/departemen')?>"
                      });
                  }).error(function(data) {
                      swal({
                          title: "Error", 
    ...
    function edit_departemen(id){
      $('.modal-title').text('Edit Master Departemen'); // Set title to Bootstrap modal title
        save_method = 'update';
        $('#form')[0].reset(); // reset form on modals

        //Ajax Load data from ajax
        $.ajax({
          url : "<?php echo site_url('master2/edit_departemen/')?>" + id,
          type: "GET",
          dataType: "JSON",
          success: function(data)
          {
   ...
   function(isConfirm){ 
      if (isConfirm) {       
        ...
        $.ajax({
            type: "post",
            url : "<?php echo site_url('master2/delete_departemen')?>/"+id,
            dataType: "JSON",
            success: function(data) { }
          }).done(function(data) {
              swal({
